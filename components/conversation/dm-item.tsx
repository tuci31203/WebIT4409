    ...
    <div className='group relative flex w-full items-center p-4 transition hover:bg-black/5'>
      <div className='group flex w-full items-start gap-x-2'>
        <div className='cursor-pointer transition hover:drop-shadow-md'>
          <UserAvatar src={profile.image!} isOnline={profile.isOnline} />
        </div>
        <div className='flex w-full flex-col'>
          <div className='flex items-center gap-x-2'>
            <div className='flex items-center'>
              <p className='cursor-pointer text-sm font-semibold hover:underline'>{profile.name}</p>
            </div>
          ...
          {!fileUrl && isEditing && (
            <Form {...form}>
              <form className='flex w-full items-center gap-x-2 pt-2' onSubmit={form.handleSubmit(onSubmit)}>
                <FormField
